...
\geometry{verbose,tmargin=2.3cm,bmargin=1.3cm,lmargin=1.2cm,rmargin=1.2cm}
...
\>\>Economics Ph.D, \emph{Topics  in Economics Development}  \`Fall 2021, `22, `23\\
\>\>Economics Ph.D, \emph{Seminar in Labor and Economic Development}  \`Fall 2020\\
\>\>Masters in Quantitative Economics, \emph{Economic Inference from Data}  \`Fall 2020, `21, `22, `23\\
...
\begin{minipage}[t]{0.8\linewidth}
\begin{mysec} 
	2023\>\> \tabfill{ Aix-Marseilles School of Economics Conference in Applied Econometrics (5/15); Wageningen University (6/6); Society of Economics of the Household Conference (6/7); Western Economics Association Conference (7/6); Early Career Behavioral Economics Conference (7/15) } \\
...
\begin{minipage}[t]{0.8\linewidth}
\begin{mysec}
2023-2024 \>\> Ph.D Admissions committee member, Univ. of Pittsburgh\\
