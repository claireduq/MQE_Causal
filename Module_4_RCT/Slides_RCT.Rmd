...
allModelsResults <- list()  # Create empty list             
formula <- list() # Create empty list
model <- list()  # Create empty list
pvals <- c()  # Create empty list
betas <- c()  # Create empty list
ses <- c()  # Create empty list
...
for (i in 5:24) {
  ...
  allModelsResults[[i]] <- summary(  model[[i]])
...
::: {.column width="40%" data-latex="{\textwidth}"}
...
::: {.column width="60%" data-latex="{\textwidth}"}
